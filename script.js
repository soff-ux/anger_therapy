...
const reflectionForm = document.getElementById("reflection");  // Fixed variable name
const positiveAnswer = document.getElementById("positivemessage");  // Changed variable name

reflectionForm.addEventListener("submit", (event) => {  // Fixed event listener
...
const ventForm = document.getElementById("venting");  // Fixed variable name
const goodAnswer = document.getElementById("positivemessagetwo");  // Changed variable name

ventForm.addEventListener("submit", (event) => {  // Fixed event listener
    event.preventDefault();
